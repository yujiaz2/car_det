...
class car(imdb):
    ...
    def _load_car_annotation(self, index):
        """
        Load image and bounding boxes info from XML file in the car
        format.
        """
    ...
    def _get_car_results_file_template(self):
    ...
    def _write_car_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            ...
            filename = self._get_car_results_file_template().format(cls)
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        self._write_car_results_file(all_boxes)
